        ...
        applyFilters() {
          const filtered = this.pokemons.filter((pokemon) => {
            const matchesNameOrId =
              pokemon.name.includes(this.searchValue) || pokemon.id.toString() === this.searchValue;
            const matchesType =
              !this.selectedType ||
              ...
              <div class="row my-3">
                ...
                <div class="col-md-6">
                  <select class="form-select" @change=${this.handleFilter}>
                    ...
                    ${['fire', 'water', 'grass', 'electric', 'rock', 'ground', 'psychic', 'ice', 'dragon', 'dark', 'fairy']
